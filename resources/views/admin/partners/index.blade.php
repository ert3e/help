...
@section('content')
    ...
    <a href="{{ route('admin.partners.add') }}" class="btn btn-primary"><i class="fa fa-plus-circle" aria-hidden="true"></i> Добавить</a>
    <div class="right">
    ...
    <div class="table-responsive" id="sortable_table">
        <table class="table">
            ...
            <tr>
                ...
                <th>Лого</th>
                <th>@include('templates.titleSort', ['title' => 'Название', 'field' => 'title'])</th>
            ...
            @else
                @foreach($models as $model)
                    <tr data-key="{{ $model->id }}" data-href="{{ route('admin.partners.edit', $model->id) }}">
                        <td>{{ $model->id }}</td>
                        <td>
                        ...
                        <td>
                            @include('templates.buttonsControl', [
                                'edit'      => route('admin.partners.edit', $model->id),
                                'delete'    => route('admin.partners.delete', $model->id),
                            ])
                        </td>
                    </tr>
                @endforeach
...
@section('footer_js')
    <script>
        enableDragSort('sortable-table', '{{ route('admin.sortable', 'Partner') }}');
    </script>
@endsection
